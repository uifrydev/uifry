      ...
      <div className="flex px-[4rem] w-full justify-center sm:hidden ">
        <div className="flex gap-[1.5rem] max-w-[1300px] w-full py-[5rem] bg-primary rounded-[3rem] ">
          <div
            ...
            className="cursor-pointer w-[19%] rounded-r-[3rem] overflow-hidden relative before:absolute before:w-full before:h-full before:bg-[#000]/[0.15] before:z-[1]"
          >
            <Image
              ...
              alt=""
            />
            <span onClick={() => setIndexImg((prev) => (prev == 0 ? 2 : prev - 1))} className="absolute z-[2] w-[7.3rem] bg-[#fff] rounded-full left-[50%] top-[50%] -translate-x-[50%] -translate-y-[50%] h-[7.3rem] middle">
          ...
          <div
            ...
            className="cursor-pointer w-[19%] rounded-l-[3rem] overflow-hidden relative before:absolute before:w-full before:h-full before:bg-[#000]/[0.15] before:z-[1]"
          >
            <Image
              src={
                images[
              ...
              className="object-cover h-full"
            />
            <span onClick={() => setIndexImg((prev) => (prev == 2 ? 0 : prev + 1))} className="absolute z-[2] w-[7.3rem] bg-[#fff] rounded-full left-[50%] top-[50%] -translate-x-[50%] -translate-y-[50%] h-[7.3rem] middle">
