  ...
  return (
    <>
      ...
      <div className="flex flex-col middle w-full bg-[#F6F9FC] py-[4.91rem] px-[2rem]">
        ...
        <div className="flex max-w-[128rem] w-full gap-[2rem] md:flex-col items-center justify-between mt-[8.5rem]">
          <div className="flex gap-[3rem] items-center xs:flex-col">
            <Image src={logo} alt="logo" />
            <span className="text-primaryBlack text-[1.6rem] xs:text-center leading-[3.2rem] mt-[1rem]">
              Premium Resources For UI UX Designers
            </span>
          </div>
          <div className="flex gap-[1rem] mt-[1rem] xs:flex-col">
            ...
            <ul className="flex middle gap-[1.6rem]">
              ...
              <li>
                <Link href={"https://www.facebook.com/uifryy"}>
                  ...
                  >
                    <path
                      d="M14.0312 12.625H15.9062L16.6562 9.625H14.0312V8.125C14.0312 7.3525 14.0312 6.625 15.5312 6.625H16.6562V4.105C16.4118 4.07275 15.4884 4 14.5134 4C12.4772 4 11.0312 5.24275 11.0312 7.525V9.625H8.78125V12.625H11.0312V19H14.0312V12.625Z"
                      fill="#B6B9CE"
                    />
                  </svg>
                </Link>
