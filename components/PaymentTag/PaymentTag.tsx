    ...
    <div className="py-[1.9rem] pl-[4rem]  pr-[2rem] bg-[#09397B] mt-[1rem] rounded-[1.6rem] relative overflow-hidden">
      ...
      <div className="z-[20]">
        <div className="flex items-center gap-[1rem]">
          <span className=" satoshi text-white text-[3.2rem] leading-[3.4rem]">$9.99/m</span>
        ...
        <div className="flex justify-between items-center">
          ...
          <p className="text-white z-[21] text-[1.4rem] p-[1rem] py-[.5rem] border-[1px] border-[#fff] rounded-[.5rem] ">
